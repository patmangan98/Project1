...
//declare constants
// Magic numbers are declared with all caps and with snake case
...
//check if guess was correct logic
// This block of code could use some blank lines to give it some breathing room and have a little more readability.
// Also could use some comments inside this code block walking use through what is happening here
const playerGuess = () => {
...
//show the correctly guessed letters to the players 
